import { withRouter } from 'next/router' import WithMDX from '../../lib/with-mdx'

import { lewi } from '../../lib/data/team' import Tangle from '../../components/tangle'

export const page = { title: 'What is IOTA', date: '16 Feburary 2018', authors: [lewi], editUrl: 'pages/introduction/what-is-iota.mdx', }
